...
namespace FakeXC.API.Migrations
{
    ...
    [Migration("20220710104307_DataSeeding2")]
            ...
            modelBuilder.Entity("FakeXC.API.Models.TouristRoute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 10, 43, 7, 106, DateTimeKind.Utc).AddTicks(6749),
                            Description = "黄山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                            Notes = "<p>小心危险<p>",
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 10, 43, 7, 109, DateTimeKind.Utc).AddTicks(1262),
                            Description = "华山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                            Notes = "<p>小心危险<p>",
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 10, 43, 7, 109, DateTimeKind.Utc).AddTicks(1572),
                            Description = "华山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                            Notes = "<p>小心危险<p>",
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 10, 43, 7, 109, DateTimeKind.Utc).AddTicks(1653),
                            Description = "华山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                            Notes = "<p>小心危险<p>",
