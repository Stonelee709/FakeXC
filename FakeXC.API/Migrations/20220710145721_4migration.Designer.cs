...
namespace FakeXC.API.Migrations
{
    ...
    [Migration("20220710145721_4migration")]
            ...
            modelBuilder.Entity("FakeXC.API.Models.TouristRoute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 14, 57, 21, 13, DateTimeKind.Utc).AddTicks(7798),
                            DepatureCity = 0,
                            Description = "黄山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 14, 57, 21, 16, DateTimeKind.Utc).AddTicks(5449),
                            DepatureCity = 0,
                            Description = "华山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 14, 57, 21, 16, DateTimeKind.Utc).AddTicks(5846),
                            DepatureCity = 0,
                            Description = "华山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
                        ...
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 7, 10, 14, 57, 21, 16, DateTimeKind.Utc).AddTicks(5972),
                            DepatureCity = 0,
                            Description = "华山一日游",
                            Feature = "<p>吃住行购物<p>",
                            Fees = "<p>交通费自理<p>",
